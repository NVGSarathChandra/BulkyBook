...
namespace DataAccess.Migrations
{
    ...
    [Migration("20201031155421_ShoppingCartAndOrderHeaderAndOrderDetails")]
    partial class ShoppingCartAndOrderHeaderAndOrderDetails
    {
            ...
            modelBuilder.Entity("Models.OrderHeader", b =>
                {
                    ...
                    b.Property<string>("ApplicatinUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("TrackingNumbr")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Models.Organization", b =>
                {
                    ...
                    b.Property<bool>("IsAuthorizedOrganization")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("OrganizatioinId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.OrderHeader", b =>
                {
                    b.HasOne("Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicatinUserId");
                });
            ...
            modelBuilder.Entity("Models.Product", b =>
                {
                    ...
                    b.HasOne("Models.CoverType", "coverType")
                        .WithMany()
